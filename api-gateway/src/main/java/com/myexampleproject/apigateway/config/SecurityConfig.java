    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        http.csrf(ServerHttpSecurity.CsrfSpec::disable)
                .authorizeExchange(ex -> ex
                        ...
                        .pathMatchers(HttpMethod.GET, "/api/system/outbox").authenticated()
                        .pathMatchers(HttpMethod.GET, "/api/system/kafka/**").authenticated()
                        .pathMatchers(HttpMethod.GET, "/api/system/kafka").authenticated()
                        .pathMatchers(HttpMethod.GET, "/api/system/saga/**").authenticated()
                        .pathMatchers(HttpMethod.GET, "/api/system/saga").authenticated()
                        .pathMatchers(HttpMethod.POST, "/api/system/kafka/**").authenticated()
